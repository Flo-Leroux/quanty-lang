...
//
// To iterate over a list (where l is a *List[V]):
//
...
func New[V Val]() *List[V] { return new(List[V]).Init() }
...
// Remove removes item at index i from l if e is an element of list l.
// It returns the element value e.Value.
// The element must not be nil.
func (l *List[V]) RemoveAt(i int) V {
...
func (l *List[V]) Filter(filter func(item V) bool) *List[V] {
	sub := New[V]()

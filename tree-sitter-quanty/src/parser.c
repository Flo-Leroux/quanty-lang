...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [2] = {
    [sym__fragment] = STATE(3),
    [sym_component_definition] = STATE(3),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [11] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(5),
  [14] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_definition, 4, .production_id = 1),

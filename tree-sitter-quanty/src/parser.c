...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [18] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_component_declaration_repeat1, 2), SHIFT_REPEAT(8),
  [21] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_component_declaration_repeat1, 2),
  [23] = {.entry = {.count = 1, .reusable = true}}, SHIFT(17),
  [25] = {.entry = {.count = 1, .reusable = true}}, SHIFT(10),
  [27] = {.entry = {.count = 1, .reusable = true}}, SHIFT(9),
  [29] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 2, .production_id = 1),
  [31] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_component_declaration, 5, .production_id = 2),
  [33] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tag, 3, .production_id = 3),
  ...
  [43] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_children, 3),
};
